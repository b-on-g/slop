...
declare namespace $ {
    ...
    const $bog_slop_metrics_ids: readonly ["em_dash", "one_liner", "heading", "filler", "triad", "pseudo_sincerity"];
    ...
    function $bog_slop_metrics(markdown: string): $bog_slop_metrics_report;
}
...
declare namespace $ {
	...
	type $mol_textarea__hint_bog_slop_1 = $mol_type_enforce<
		...
		ReturnType< $mol_textarea['hint'] >
	>
	type $mol_textarea__value_bog_slop_2 = $mol_type_enforce<
		ReturnType< $bog_slop['text'] >
		,
		ReturnType< $mol_textarea['value'] >
	>
	type $mol_view__sub_bog_slop_3 = $mol_type_enforce<
		ReturnType< $bog_slop['report'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_slop_4 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_slop_verdict__tier_bog_slop_5 = $mol_type_enforce<
		ReturnType< $bog_slop['tier'] >
		,
		ReturnType< $bog_slop_verdict['tier'] >
	>
	type $bog_slop_verdict__index_bog_slop_6 = $mol_type_enforce<
		ReturnType< $bog_slop['index_label'] >
		,
		ReturnType< $bog_slop_verdict['index'] >
	>
	type $bog_slop_verdict__label_bog_slop_7 = $mol_type_enforce<
		ReturnType< $bog_slop['tier_label'] >
		,
		ReturnType< $bog_slop_verdict['label'] >
	>
	type $bog_slop_verdict__note_bog_slop_8 = $mol_type_enforce<
		ReturnType< $bog_slop['paras_label'] >
		,
		ReturnType< $bog_slop_verdict['note'] >
	>
	type $mol_view__sub_bog_slop_9 = $mol_type_enforce<
		ReturnType< $bog_slop['metric_rows'] >
		,
		ReturnType< $mol_view['sub'] >
	>
	type $mol_view__sub_bog_slop_10 = $mol_type_enforce<
		readonly(any)[]
		,
		ReturnType< $mol_view['sub'] >
	>
	type $bog_slop_bar__title_bog_slop_11 = $mol_type_enforce<
		ReturnType< $bog_slop['metric_title'] >
		,
		ReturnType< $bog_slop_bar['title'] >
	>
	type $bog_slop_bar__value_bog_slop_12 = $mol_type_enforce<
		ReturnType< $bog_slop['metric_value'] >
		,
		ReturnType< $bog_slop_bar['value'] >
	>
	type $bog_slop_bar__portion_bog_slop_13 = $mol_type_enforce<
